...
import { BOOKS_URL } from "./imgs/books";
...
async function up() {
  ...
  const books = [
    ...
    },
    {
      ...
      copies: 77,
      views: 70,
      bookCoverURL: BOOKS_URL["book-10"],
    },
    {
      ...
      copies: 40,
      views: 58,
      bookCoverURL: BOOKS_URL["book-11"],
    },
    {
      ...
      copies: 33,
      views: 34,
      bookCoverURL: BOOKS_URL["book-12"],
    },
    {
      ...
      copies: 70,
      views: 99,
      bookCoverURL: BOOKS_URL["book-13"],
    },
    {
      title:
      ...
      copies: 67,
      views: 44,
      bookCoverURL: BOOKS_URL["book-14"],
    },
    {
      title:
      ...
      copies: 33,
      views: 22,
      bookCoverURL: BOOKS_URL["book-15"],
    },
    {
      ...
      copies: 12,
      views: 45,
      bookCoverURL: BOOKS_URL["book-16"],
    },
    {
      title:
      ...
      copies: 5,
      views: 78,
      bookCoverURL: BOOKS_URL["book-17"],
    },
    {
      title: "Теория Всего",
      ...
      copies: 45,
      views: 89,
      bookCoverURL: BOOKS_URL["book-18"],
    },
  ];
