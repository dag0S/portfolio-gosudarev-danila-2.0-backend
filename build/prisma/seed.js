    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const books = [
            ...
            },
            {
                ...
                description: "Искусственный интеллект — часть нашей повседневной жизни. Мы встречаемся с его проявлениями, когда занимаемся шопингом в интернет-магазинах, получаем рекомендации «вам может понравиться этот фильм», узнаем медицинские диагнозы… \nЧтобы уверенно ориентироваться в новом мире, необходимо понимать алгоритмы, лежащие в основе ИИ.",
                copies: 23,
                views: 46,
            ...
            },
            {
                ...
                description: "Книги по информационной безопасности (ИБ) преимущественно делятся на две группы: в одних большей частью присутствует нормативная информация и мало сведений о технической реализации угроз и защите от них, в других описываются только технические аспекты (серии «...глазами хакера»).",
                copies: 68,
                views: 103,
            ...
            },
            {
                ...
                description: "Константин Владимиров — IT-специалист с более чем 20-летним стажем, преподаватель кафедры микропроцессорных технологий в МФТИ, постоянный спикер технических конференций по темам С++, компиляторов и высокопроизводительных вычислений, автор популярного канала @tilir.",
                copies: 55,
                views: 78,
            ...
            },
            {
                ...
                genres: ["Биология"],
                description: "Эта книга — самый полный путеводитель по работе мозга и биологическим потребностям человека. Написанная профессором, доктором биологических наук Вячеславом Дубыниным, она приближает читателя к пониманию собственного организма, учит управлять природными механизмами тела, чтобы реализовать личную одаренность.",
                copies: 40,
                views: 58,
            ...
            },
            {
                ...
                author: "Сайбал Гош",
                genres: ["DevOps"],
                description: "Книга подробно рассказывает о развертывании и поддержке контейнерных приложений с использованием технологии Docker. Описан принцип работы образов, контейнеров и связанных с ними хранилищ Docker Storage, рассмотрена система контейнеризации Docker Swarm, показаны принципы сетевого взаимодействия Container Network Model. Раскрыты вопросы использования плагинов в сервисах Docker, рассмотрено развертывание служб в Swarm. Отдельная глава посвящена обеспечению безопасности в экосистеме Docker, масштабированию и поддержке контейнерных приложений.",
                copies: 70,
                views: 99,
                bookCoverURL: "book-13.webp",
            },
            {
                title: "Взломать всё: Как сильные мира сего используют уязвимости систем в своих интересах",
                author: "Брюс Шнайер",
                genres: ["Информационная безопасность (ИБ)"],
                description: "Классический образ хакера — это специалист ИТ высочайшего класса, который знает несколько языков программирования, разбирается в устройстве систем безопасности и в два счета подберет пароль к вашему почтовому ящику. Он изучает системы для того, чтобы найти в них уязвимости и заставить работать в своих интересах. Однако взламывать можно не только компьютеры, но и социальные системы: от налогового законодательства до финансовых рынков и политики.",
                copies: 67,
                views: 44,
            ...
            },
            {
                ...
                description: "Разработка многофункционального сайта, как правило, требует нескольких разных специалистов, но в данной книге мы расскажем, как все сделать самому! Fullstack-разработчик — это разработчик, который обладает знаниями всех технологий (полным стеком) для создания полноценных многофункциональных веб-сайтов. Данная книга посвящена Fullstack-разработке сайта.",
                copies: 33,
                views: 22,
            ...
            },
            {
                ...
                description: "Облегчення версия Краткой истории времени, magnum opus Стивена Хокинга. Еще меньше сложных построений, больше отвлеченных иллюстраций, больше прозрачных параллелей.",
                copies: 45,
                views: 89,
            ...
            },
            {
                ...
                author: "А. Ярошенко",
                genres: ["Кибербезопасность", "Информационная безопасность (ИБ)"],
                description: "Данная книга расскажет, как получить несанкционированный доступ к веб-серверу, или, попросту говоря, как его взломать.",
                copies: 56,
                views: 78,
            ...
            },
            {
                ...
                description: "Книга идеально подойдет всем, кто каждый день пользуется Linux. В обновленном издании описывается более 200 команд Linux, в том числе новые команды управления файлами, пакетами и версиями исходного кода, преобразования форматов файлов и многие другие. \nАвтор книги Дэниел Барретт приводит наиболее полезные команды Linux, сгруппированные по функциональности. Это практическое издание станет идеальным справочником по Linux и для новичков, и для опытных пользователей.",
                copies: 109,
                views: 203,
            ...
            },
            {
                ...
                genres: ["Физика"],
                description: "Почему человеку, сидящему в поезде, кажется, что поезд стоит на месте, а движется перрон? Если ударить яйцом о яйцо, какое из них разобьется первым? О чем спорили Коперник и Птолемей? Каков принцип действия аэродинамической трубы?..",
                copies: 55,
                views: 37,
            ...
            },
            {
                ...
                description: "В этом справочнике вы найдете ключевую информацию об операционной системе Linux в удобной и наглядной форме. Структура справочника позволяет линуксоидам быстро находить нужную информацию, получать примеры использования тех или иных элементов Linux. Диапазон материалов справочника достаточно широк: от самых основ (командная строка, локальная сеть, файловая система, пользователи и группы) до более продвинутых тем (управление загрузкой ос, работа с хранилищем, управление процессами Linux). Отдельное внимание уделено внимание таким важным темам, как: ядро Linux, маршрутизация и настройка брандмауэра, командный интерпретатор bash. Книга будет полезна как начинающим линуксоидам, так и более опытным пользователям, которым в процессе работы в Linux нужна информация под рукой.",
                copies: 99,
                views: 129,
            ...
            },
            {
                ...
                author: "Дэниел Грэм",
                genres: ["Информационная безопасность (ИБ)", "Кибербезопасность"],
                description: "Практическое руководство по взлому компьютерных систем с нуля, от перехвата трафика до создания троянов. Книга «Этичный хакинг» освещает современные проблемы кибербезопасности и помогает освоить навыки, необходимые любому этичному хакеру. Сделайте первый шаг в карьере пентестера, ознакомившись с методами взлома, которые используют эксперты.",
                copies: 66,
                views: 177,
